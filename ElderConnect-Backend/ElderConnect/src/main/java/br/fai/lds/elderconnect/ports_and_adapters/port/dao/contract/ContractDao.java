...
public interface ContractDao extends CrudDao<Contract>, RatingContractDao, FinishContractDao, CancelContractDao, ReadByCaregiverIdDao, ReadBySeniorIdDao, ActivateContractDao {
}

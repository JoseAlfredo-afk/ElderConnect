...
VALUES ('111.111.111-11', 'Maria de Olinda', 'maria@email.com', '12345678', '(35) 99191-9191', 'IDOSO', '1938-04-21');

INSERT INTO user_model(cpf, fullname, email, password, phone_number, user_type, birth_date)
VALUES ('222.222.222-22', 'João Silva', 'joao@email.com', '23456788', '(35) 99999-9999', 'IDOSO', '1945-06-27');
...
VALUES ('333.333.333-33', 'Juliana Mota', 'juliana@email.com', 'juju2108', '(35) 99193-9393', 'CUIDADOR', '2001-12-01',
...
INSERT INTO user_model(cpf, fullname, email, password, phone_number, user_type, birth_date, availability_schedule,
                       street_address, specialization, city, neighborhood, experience)
VALUES ('444.444.444-44', 'Paulo Santos', 'paulo@email.com', '03456777', '(35) 94444-5555', 'CUIDADOR', '1998-05-25',
...
INSERT INTO user_model(cpf, fullname, email, password, phone_number, user_type, birth_date, availability_schedule,
                       street_address, specialization, city, neighborhood, experience)
VALUES ('555.555.555-55', 'Larissa Silva', 'larissa@email.com', '52345564', '(35) 99595-9595', 'CUIDADOR', '2005-08-28',
